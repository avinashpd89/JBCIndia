    ...
    <div style={{ background: '#fff' }}>
      ...
      <section className="section-padding" style={{ background: 'var(--primary)', color: '#fff', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: 1000 }}>
          <h1 style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 800, marginBottom: '20px' }}>Contact Us</h1>
      ...
      <div className="section-padding container">
        <div className="responsive-grid" style={{ gridTemplateColumns: '1.2fr 0.8fr', gap: '80px' }}>
          
          {/* Contact Form */}
          <div style={{ background: '#fff', padding: 'clamp(20px, 4vw, 40px)', borderRadius: '16px', boxShadow: '0 10px 40px rgba(0,0,0,0.05)', border: '1px solid #eee' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--primary)', marginBottom: '32px' }}>Ask Our Experts</h2>
          ...
          <div>
            <div style={{ marginBottom: '48px' }}>
              <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--primary)', marginBottom: '32px' }}>Our Offices</h2>
              
              <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                {/* Varanasi */}
                <div style={{ display: 'flex', gap: '20px' }}>
                  <div style={{ width: '48px', height: '48px', background: 'var(--bg-light)', color: 'var(--secondary)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <FiMapPin size={24} />
                  </div>
                  <div>
                    <h3 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--primary)', marginBottom: '8px' }}>Admin Office (Varanasi)</h3>
                ...
                <div style={{ display: 'flex', gap: '20px' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--primary)', marginBottom: '8px' }}>Head Office (Patna)</h3>
                    <p style={{ fontSize: '15px', color: 'var(--text-muted)', lineHeight: 1.6 }}>
                ...
                <div style={{ display: 'flex', gap: '20px' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--primary)', marginBottom: '8px' }}>Phone & Support</h3>
                    <p style={{ fontSize: '15px', color: 'var(--text-muted)', lineHeight: 1.6 }}>
                      +91-9532063489
                    </p>
                  </div>
                ...
                <div style={{ display: 'flex', gap: '20px' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--primary)', marginBottom: '8px' }}>Email</h3>
                    <p style={{ fontSize: '15px', color: 'var(--text-muted)', lineHeight: 1.6 }}>
            ...
            <div style={{ background: 'var(--primary)', padding: '30px', borderRadius: '12px', color: '#fff' }}>
